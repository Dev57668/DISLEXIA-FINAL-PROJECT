/* =========================================================
   STAGE 4 QUESTION BANK — NUMBER NINJA (CLASSES 1 TO 5)
   Mathematical Thinking & Numerical Logic
   5 Classes × 3 Levels × 10 Questions = 150 Questions
   ========================================================= */
...
export const mathQuestionBanks = {
  ...
  5: {
    1: [
      { question: "What is 12,450 + 8,375?", options: ["20,725", "20,925", "21,025", "20,825"], answer: "20,825", hint: "Column Addition: Line up digits by place value (ones, tens, hundreds, thousands). Add column-by-column from right to left, carrying over when a sum reaches 10 or more." },
      { question: "What is 15,000 - 6,725?", options: ["8,275", "8,175", "8,375", "8,475"], answer: "8,275", hint: "Column Subtraction: Align numbers by place value. Subtract from right to left, borrowing (regrouping) from the left column when a top digit is smaller than the bottom digit." },
      { question: "What is 125 × 8?", options: ["900", "1,000", "950", "1,050"], answer: "1,000", hint: "Multiplication Strategy: Break 125 down: (100 × 8 = 800) + (25 × 8 = 200). 800 + 200 = 1,000." },
      { question: "What is 144 ÷ 12?", options: ["10", "11", "12", "14"], answer: "12", hint: "Division Strategy: Think of times tables: what number multiplied by 12 gives 144? 12 × 12 = 144." },
      { question: "What is 3/4 + 1/4?", options: ["1", "1/2", "3/4", "5/4"], answer: "1", hint: "Fraction Addition: Since denominators are equal (4), keep the bottom 4 and add numerators: 3 + 1 = 4. 4/4 makes 1 whole." },
      { question: "What is 2.75 + 1.25?", options: ["3.5", "4", "4.25", "4.5"], answer: "4", hint: "Decimal Strategy: Align decimal points vertically. Add hundredths (0.75 + 0.25 = 1.00), then add whole numbers (2 + 1 = 3). 3 + 1.00 = 4.00." },
      { question: "What is 25% of 100?", options: ["10", "20", "25", "50"], answer: "25", hint: "Percentage Strategy: 'Percent' means per 100. 25% of 100 is simply 25 out of 100." },
      { question: "What is the average of 10, 20 and 30?", options: ["15", "25", "30", "20"], answer: "20", hint: "Average Strategy: Add the three numbers (10 + 20 + 30 = 60), then divide by 3: 60 ÷ 3 = 20." },
      { question: "A rectangle is 8 cm long and 5 cm wide. What is its area?", options: ["13 cm²", "40 cm²", "26 cm²", "45 cm²"], answer: "40 cm²", hint: "Area Strategy: Multiply Length × Width: 8 cm × 5 cm = 40 cm²." },
      { question: "How many centimetres are in 3 metres?", options: ["30", "100", "300", "200"], answer: "300", hint: "Metric Conversion: 1 metre = 100 cm, so 3 metres = 3 × 100 = 300 cm." },
    ],

    2: [
      { question: "What is 15,250 + 7,850?", options: ["22,100", "24,100", "25,100", "23,100"], answer: "23,100", hint: "Column Addition: Line up digits by place value and add right-to-left: 250 + 850 = 1,100, 15,000 + 7,000 + 1,100 = 23,100." },
      { question: "What is 20,000 - 8,750?", options: ["11,250", "10,250", "12,250", "13,250"], answer: "11,250", hint: "Column Subtraction: Subtract 8,000 from 20,000 = 12,000, then subtract 750 = 11,250." },
      { question: "What is 45 × 12?", options: ["440", "500", "540", "560"], answer: "540", hint: "Multiplication Strategy: Multiply 45 × 10 = 450, and 45 × 2 = 90. Add them: 450 + 90 = 540." },
      { question: "What is 360 ÷ 12?", options: ["20", "25", "35", "30"], answer: "30", hint: "Division Strategy: Since 36 ÷ 12 = 3, 360 ÷ 12 = 30." },
      { question: "What is 2/5 + 1/5?", options: ["3/5", "2/5", "4/5", "1"], answer: "3/5", hint: "Fraction Addition: Denominators are the same (5), so add numerators: 2 + 1 = 3, giving 3/5." },
      { question: "What is 0.25 as a fraction?", options: ["1/2", "1/4", "1/3", "3/4"], answer: "1/4", hint: "Decimal to Fraction: 0.25 is 25/100, which simplifies to 1/4." },
      { question: "What is 10% of 500?", options: ["25", "40", "100", "50"], answer: "50", hint: "Percentage Strategy: To find 10% of any number, divide it by 10: 500 ÷ 10 = 50." },
      { question: "What is the perimeter of a rectangle 8 cm × 5 cm?", options: ["26 cm", "13 cm", "20 cm", "40 cm"], answer: "26 cm", hint: "Perimeter Strategy: Add all four outer sides: 2 × (8 + 5) = 2 × 13 = 26 cm." },
      { question: "What is 5.5 + 2.5?", options: ["7", "8", "9", "10"], answer: "8", hint: "Decimal Strategy: Add the halves: 0.5 + 0.5 = 1.0. Add the wholes: 5 + 2 = 7. 7 + 1 = 8." },
      { question: "What is 3/4 of 20?", options: ["10", "12", "15", "18"], answer: "15", hint: "Fraction of a Quantity: Divide 20 by 4 = 5, then multiply by 3: 5 × 3 = 15." },
    ],

    3: [
      { question: "What is 25,000 + 17,500?", options: ["42,500", "40,500", "41,500", "43,500"], answer: "42,500", hint: "Column Addition: 25,000 + 17,000 = 42,000, plus 500 = 42,500." },
      { question: "What is 30,000 - 12,750?", options: ["16,250", "17,250", "18,250", "19,250"], answer: "17,250", hint: "Column Subtraction: 30,000 - 12,000 = 18,000, minus 750 = 17,250." },
      { question: "What is 125 × 16?", options: ["1,500", "2,500", "2,000", "3,000"], answer: "2,000", hint: "Multiplication Strategy: 125 × 8 = 1,000, so 125 × 16 is double that: 2,000." },
      { question: "What is 625 ÷ 25?", options: ["20", "30", "35", "25"], answer: "25", hint: "Division Strategy: 25 × 25 = 625, so 625 ÷ 25 = 25." },
      { question: "What is 3/5 + 1/5?", options: ["3/5", "4/5", "5/5", "6/5"], answer: "4/5", hint: "Fraction Addition: Keep denominator 5 and add 3 + 1 = 4, giving 4/5." },
      { question: "What is 50% of 240?", options: ["100", "140", "120", "160"], answer: "120", hint: "Percentage Strategy: 50% means exactly half: 240 ÷ 2 = 120." },
      { question: "What is 3.75 + 2.25?", options: ["5", "6.5", "7", "6"], answer: "6", hint: "Decimal Strategy: 0.75 + 0.25 = 1.00. 3 + 2 = 5. Total = 5 + 1.00 = 6." },
      { question: "A rectangle is 12 cm long and 7 cm wide. What is its area?", options: ["84 cm²", "19 cm²", "38 cm²", "96 cm²"], answer: "84 cm²", hint: "Area Strategy: Multiply Length × Width: 12 × 7 = 84 cm²." },
      { question: "What is the average of 20, 30 and 40?", options: ["20", "35", "30", "40"], answer: "30", hint: "Average Strategy: 20 + 30 + 40 = 90. Divide by 3: 90 ÷ 3 = 30." },
      { question: "What is 1.5 metres in centimetres?", options: ["15", "100", "200", "150"], answer: "150", hint: "Metric Conversion: 1 m = 100 cm, 0.5 m = 50 cm. 100 + 50 = 150 cm." },
    ],
  },
};
