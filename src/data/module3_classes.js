/* =========================================================
   MODULE 03 QUESTION BANK — CLASS 1 TO 5
   Written Expression & Language Encoding
   5 Classes × 3 Levels (Easy, Medium, Hard) × 9 Questions = 135 Questions
   Audited with dyslexia-friendly hints and multiple accepted answers.
   ========================================================= */
    ...
    exercises: [
      {
        ...
        hint: "Think of a furry pet that meows, or a small cozy bed for a baby."
      },
      {
        id: "c1-s3-l1-q2",
        prompt: "Complete: D _ G",
        question: "Fill in the missing letter to complete the word: D _ G",
        answer: "DOG",
        acceptedAnswers: ["dog", "dig", "o", "i"],
        hint: "Think of a playful pet that barks, or what you do with a shovel in the garden."
      },
      {
        id: "c1-s3-l1-q3",
        prompt: "Complete: S _ N",
        question: "Fill in the missing letter to complete the word: S _ N",
        answer: "SUN",
        acceptedAnswers: ["sun", "son", "u", "o"],
        hint: "Think of what shines bright in the daytime sky, or a boy in relation to his parents."
      },
      {
        id: "c1-s3-l1-q4",
        prompt: "Complete: M _ P",
        question: "Fill in the missing letter to complete the word: M _ P",
        answer: "MAP",
        acceptedAnswers: ["map", "mop", "a", "o"],
        hint: "Think of a guide that shows roads and cities, or a tool used for cleaning floors."
      },
      {
        id: "c1-s3-l1-q5",
        prompt: "Complete: B _ D",
        question: "Fill in the missing letter to complete the word: B _ D",
        answer: "BED",
        acceptedAnswers: ["bed", "bad", "bud", "e", "a", "u"],
        hint: "Think of where you sleep at night, or a flower before its petals open."
      },
      {
        id: "c1-s3-l1-q6",
        prompt: "Complete: F _ SH",
        question: "Fill in the missing letter to complete the word: F _ SH",
        answer: "FISH",
        acceptedAnswers: ["fish", "i"],
        hint: "Think of an animal with fins that breathes underwater and swims in rivers."
      },
      {
        id: "c1-s3-l1-q7",
        prompt: "Complete: TR _ E",
        question: "Fill in the missing letter to complete the word: TR _ E",
        answer: "TREE",
        acceptedAnswers: ["tree", "e"],
        hint: "Think of a tall woody plant with green leaves that birds nest in."
      },
      {
        id: "c1-s3-l1-q8",
        prompt: "Complete: B _ LL",
        question: "Fill in the missing letter to complete the word: B _ LL",
        answer: "BALL",
        acceptedAnswers: ["ball", "bell", "bull", "bill", "a", "e", "u", "i"],
        hint: "Think of a round toy you throw and catch, or an instrument that rings."
      },
      {
        id: "c1-s3-l1-q9",
        prompt: "Complete: H _ T",
        question: "Fill in the missing letter to complete the word: H _ T",
        answer: "HAT",
        acceptedAnswers: ["hat", "hot", "hit", "hut", "a", "o", "i", "u"],
        hint: "Think of something you wear on your head, or how summer weather feels."
      }
    ]
  },
  {
    ...
    exercises: [
      {
        id: "c1-s3-l2-q1",
        prompt: "Arrange: T / C / A",
        question: "Unscramble the letters to make a word: T / C / A",
        answer: "CAT",
        acceptedAnswers: ["cat", "act"],
        hint: "A friendly pet that purrs, or what performers do on a stage."
      },
      {
        id: "c1-s3-l2-q2",
        prompt: "Arrange: G / D / O",
        question: "Unscramble the letters to make a word: G / D / O",
        answer: "DOG",
        acceptedAnswers: ["dog", "god"],
        hint: "A loyal pet with a wagging tail that loves to play fetch."
      },
      {
        id: "c1-s3-l2-q3",
        prompt: "Arrange: N / S / U",
        question: "Unscramble the letters to make a word: N / S / U",
        answer: "SUN",
        acceptedAnswers: ["sun"],
        hint: "The glowing star that brings warm light to our planet every day."
      },
      {
        id: "c1-s3-l2-q4",
        prompt: "Arrange: G / B / A",
        question: "Unscramble the letters to make a word: G / B / A",
        answer: "BAG",
        acceptedAnswers: ["bag", "gab"],
        hint: "Something with straps or handles you use to carry your school supplies."
      },
      {
        id: "c1-s3-l2-q5",
        prompt: "Arrange: N / R / U",
        question: "Unscramble the letters to make a word: N / R / U",
        answer: "RUN",
        acceptedAnswers: ["run", "urn"],
        hint: "To travel quickly on your feet at a speed faster than walking."
      },
      {
        id: "c1-s3-l2-q6",
        prompt: "Arrange: P / M / A",
        question: "Unscramble the letters to make a word: P / M / A",
        answer: "MAP",
        acceptedAnswers: ["map"],
        hint: "An illustrated drawing of roads, rivers, and cities that guides travelers."
      },
      {
        id: "c1-s3-l2-q7",
        prompt: "Arrange: S / F / H / I",
        question: "Unscramble the letters to make a word: S / F / H / I",
        answer: "FISH",
        acceptedAnswers: ["fish"],
        hint: "An animal with fins and scales that glides through the water."
      },
      {
        id: "c1-s3-l2-q8",
        prompt: "Arrange: K / O / B / O",
        question: "Unscramble the letters to make a word: K / O / B / O",
        answer: "BOOK",
        acceptedAnswers: ["book"],
        hint: "Bound pages filled with interesting stories, facts, and pictures to read."
      },
      {
        id: "c1-s3-l2-q9",
        prompt: "Arrange: E / T / R / E",
        question: "Unscramble the letters to make a word: E / T / R / E",
        answer: "TREE",
        acceptedAnswers: ["tree"],
        hint: "A tall plant with a trunk, spreading branches, and shady green leaves."
      }
    ]
  },
  {
...
export const CLASS2_STAGE3_BANK = [
  {
    ...
    exercises: [
      ...
      {
        id: "c2-s3-l1-q2",
        prompt: "Complete: CH _ IR",
        question: "Fill in the missing letter to complete the word: CH _ IR",
        answer: "CHAIR",
        acceptedAnswers: ["chair", "a"],
        hint: "Think of a piece of furniture with four legs that you sit on at your desk."
      },
      {
        id: "c2-s3-l1-q3",
        prompt: "Complete: F _ SH",
        ...
        answer: "FISH",
        acceptedAnswers: ["fish", "i"],
        hint: "An aquatic creature that swims in rivers and oceans using fins and a tail."
      },
      {
        id: "c2-s3-l1-q4",
        prompt: "Complete: TR _ IN",
        question: "Fill in the missing letter to complete the word: TR _ IN",
        answer: "TRAIN",
        acceptedAnswers: ["train", "a"],
        hint: "A long vehicle made of connected passenger cars that travels along railroad tracks."
      },
      {
        id: "c2-s3-l1-q5",
        prompt: "Complete: GR _ EN",
        question: "Fill in the missing letter to complete the word: GR _ EN",
        answer: "GREEN",
        acceptedAnswers: ["green", "e"],
        hint: "The color of fresh lawn grass, tree leaves, and ripe limes."
      },
      {
        id: "c2-s3-l1-q6",
        prompt: "Complete: BL _ CK",
        question: "Fill in the missing letter to complete the word: BL _ CK",
        answer: "BLACK",
        acceptedAnswers: ["black", "block", "a", "o"],
        hint: "The dark color of the midnight sky, or a building block toy."
      },
      {
        id: "c2-s3-l1-q7",
        prompt: "Complete: SM _ LE",
        question: "Fill in the missing letter to complete the word: SM _ LE",
        answer: "SMILE",
        acceptedAnswers: ["smile", "i"],
        hint: "A joyful expression on your face that shows happiness and turns your lips upward."
      },
      {
        id: "c2-s3-l1-q8",
        prompt: "Complete: FL _ WER",
        question: "Fill in the missing letter to complete the word: FL _ WER",
        answer: "FLOWER",
        acceptedAnswers: ["flower", "o"],
        hint: "A colorful plant blossom with fragrant petals that bees love to visit."
      },
      {
        id: "c2-s3-l1-q9",
        prompt: "Complete: PL _ Y",
        question: "Fill in the missing letter to complete the word: PL _ Y",
        answer: "PLAY",
        acceptedAnswers: ["play", "ploy", "a", "o"],
        hint: "To engage in fun games and activities with your friends."
      }
    ]
  },
  {
    ...
    exercises: [
      {
        id: "c2-s3-l2-q1",
        prompt: "Arrange: P / I / S / H",
        question: "Unscramble the letters to make a word: P / I / S / H",
        answer: "SHIP",
        acceptedAnswers: ["ship", "hips"],
        hint: "A large ocean-going vessel, or body joints below your waist."
      },
      {
        id: "c2-s3-l2-q2",
        prompt: "Arrange: H / A / R / C / I",
        question: "Unscramble the letters to make a word: H / A / R / C / I",
        answer: "CHAIR",
        acceptedAnswers: ["chair"],
        hint: "A comfortable seat with a backrest found in your classroom."
      },
      {
        id: "c2-s3-l2-q3",
        prompt: "Arrange: R / N / A / I / T",
        question: "Unscramble the letters to make a word: R / N / A / I / T",
        answer: "TRAIN",
        acceptedAnswers: ["train"],
        hint: "A powerful locomotive that pulls railway cars across tracks."
      },
      {
        id: "c2-s3-l2-q4",
        prompt: "Arrange: H / O / C / L / O / S",
        question: "Unscramble the letters to make a word: H / O / C / L / O / S",
        answer: "SCHOOL",
        acceptedAnswers: ["school"],
        hint: "The building where students gather each day to learn from their teachers."
      },
      {
        id: "c2-s3-l2-q5",
        prompt: "Arrange: L / W / O / R / F / E",
        question: "Unscramble the letters to make a word: L / W / O / R / F / E",
        answer: "FLOWER",
        acceptedAnswers: ["flower", "reflow"],
        hint: "A blossoming garden plant with delicate, colorful petals."
      },
      {
        id: "c2-s3-l2-q6",
        prompt: "Arrange: R / D / N / A / E / G",
        question: "Unscramble the letters to make a word: R / D / N / A / E / G",
        answer: "GARDEN",
        acceptedAnswers: ["garden", "danger"],
        hint: "A peaceful plot of ground where flowers grow, or a warning of something unsafe."
      },
      {
        id: "c2-s3-l2-q7",
        prompt: "Arrange: H / E / A / T / R / C / E",
        question: "Unscramble the letters to make a word: H / E / A / T / R / C / E",
        answer: "TEACHER",
        acceptedAnswers: ["teacher"],
        hint: "An educator who guides and helps children discover new knowledge."
      },
      {
        id: "c2-s3-l2-q8",
        prompt: "Arrange: N / I / G / R / O / M / N",
        question: "Unscramble the letters to make a word: N / I / G / R / O / M / N",
        answer: "MORNING",
        acceptedAnswers: ["morning"],
        hint: "The early part of the day starting from sunrise until noon."
      },
      {
        id: "c2-s3-l2-q9",
        prompt: "Arrange: T / U / C / R / E / P / I",
        question: "Unscramble the letters to make a word: T / U / C / R / E / P / I",
        answer: "PICTURE",
        acceptedAnswers: ["picture"],
        hint: "A visual painting, photograph, or drawing shown in a frame."
      }
    ]
  },
  {
...
export const CLASS3_STAGE3_BANK = [
  {
    ...
    exercises: [
      {
        id: "c3-s3-l1-q1",
        prompt: "Complete: BEAUTI_ UL",
        question: "Fill in the missing letter to complete the word: BEAUTI_ UL",
        answer: "F",
        acceptedAnswers: ["f", "beautiful"],
        hint: "Think of an adjective that describes something lovely, graceful, or pleasing to see."
      },
      {
        id: "c3-s3-l1-q2",
        prompt: "Complete: FRI_ ND",
        question: "Fill in the missing letter to complete the word: FRI_ ND",
        answer: "E",
        acceptedAnswers: ["e", "friend"],
        hint: "A companion you trust, play with, and share fun memories together."
      },
      {
        id: "c3-s3-l1-q3",
        prompt: "Complete: TEA_ HER",
        question: "Fill in the missing letter to complete the word: TEA_ HER",
        answer: "C",
        acceptedAnswers: ["c", "teacher"],
        hint: "The person in your school classroom who presents lessons and guides your learning."
      },
      {
        id: "c3-s3-l1-q4",
        prompt: "Complete: SCH_ OL",
        question: "Fill in the missing letter to complete the word: SCH_ OL",
        answer: "O",
        acceptedAnswers: ["o", "school"],
        hint: "The place with desks, chalkboards, and books where children go to learn."
      },
      {
        id: "c3-s3-l1-q5",
        prompt: "Complete: GARD_ N",
        question: "Fill in the missing letter to complete the word: GARD_ N",
        answer: "E",
        acceptedAnswers: ["e", "garden"],
        hint: "An outdoor plot of earth planted with vibrant flowers and vegetables."
      },
      {
        id: "c3-s3-l1-q6",
        prompt: "Complete: MOR_ ING",
        question: "Fill in the missing letter to complete the word: MOR_ ING",
        answer: "N",
        acceptedAnswers: ["n", "morning"],
        hint: "The period from dawn until midday when the sun rises."
      },
      {
        id: "c3-s3-l1-q7",
        prompt: "Complete: PICT_ RE",
        question: "Fill in the missing letter to complete the word: PICT_ RE",
        answer: "U",
        acceptedAnswers: ["u", "picture"],
        hint: "A visual drawing, photograph, or illustration."
      },
      {
        id: "c3-s3-l1-q8",
        prompt: "Complete: ANS_ ER",
        question: "Fill in the missing letter to complete the word: ANS_ ER",
        answer: "W",
        acceptedAnswers: ["w", "answer"],
        hint: "The solution or reply you give when someone asks a question."
      },
      {
        id: "c3-s3-l1-q9",
        prompt: "Complete: QUES_ ION",
        question: "Fill in the missing letter to complete the word: QUES_ ION",
        answer: "T",
        acceptedAnswers: ["t", "question"],
        hint: "A sentence that asks for information and ends with a question mark."
      }
    ]
  },
  {
    ...
    exercises: [
      {
        ...
        question: "Complete the number sequence: 2, 4, 6, __",
        answer: "8",
        acceptedAnswers: ["8", "eight"],
        hint: "Count upwards by twos: add 2 to the number 6."
      },
      {
        id: "c4-s3-l1-q2",
        prompt: "What comes next? A, C, E, __",
        question: "Complete the letter pattern: A, C, E, __",
        answer: "G",
        acceptedAnswers: ["g"],
        hint: "Skip one letter each time: skip B, skip D, skip F."
      },
      {
        id: "c4-s3-l1-q3",
        prompt: "Complete: EDUCATI_ N",
        question: "Fill in the missing letter: EDUCATI_ N",
        answer: "O",
        acceptedAnswers: ["o", "education"],
        hint: "The process of receiving systematic instruction and schooling (ends in -tion)."
      },
      {
        id: "c4-s3-l1-q4",
        prompt: "Complete: COMMUNIT_",
        question: "Fill in the missing letter: COMMUNIT_",
        answer: "Y",
        acceptedAnswers: ["y", "community"],
        hint: "A group of people living in the same neighborhood or town (ends with the /ee/ sound)."
      },
      {
        id: "c4-s3-l1-q5",
        prompt: "Complete: INFORMATI_ N",
        question: "Fill in the missing letter: INFORMATI_ N",
        answer: "O",
        acceptedAnswers: ["o", "information"],
        hint: "Facts provided or learned about something (features the suffix -tion)."
      },
      {
        id: "c4-s3-l1-q6",
        prompt: "Complete: EXPERIENC_",
        question: "Fill in the missing letter: EXPERIENC_",
        answer: "E",
        acceptedAnswers: ["e", "experience"],
        hint: "Practical contact with and observation of facts or events."
      },
      {
        id: "c4-s3-l1-q7",
        prompt: "Complete: DIFFEREN_",
        question: "Fill in the missing letter: DIFFEREN_",
        answer: "T",
        acceptedAnswers: ["t", "different", "difference"],
        hint: "Not the same as another; unlike in nature, form, or quality."
      },
      {
        id: "c4-s3-l1-q8",
        prompt: "Complete: KNOWLEDG_",
        question: "Fill in the missing letter: KNOWLEDG_",
        answer: "E",
        acceptedAnswers: ["e", "knowledge"],
        hint: "Facts, skills, and information acquired through learning and experience."
      },
      {
        id: "c4-s3-l1-q9",
        prompt: "Complete: IMPORTAN_",
        question: "Fill in the missing letter: IMPORTAN_",
        answer: "T",
        acceptedAnswers: ["t", "important"],
        hint: "Of great significance, value, or consequence."
      }
    ]
  },
  {
...
export const CLASS5_STAGE3_BANK = [
  {
    ...
    title: "Level 1 — Easy",
    difficulty: "EASY",
    description: "Numerical and advanced vocabulary completion.",
    exercises: [
      {
        id: "c5-s3-l1-q1",
        prompt: "What comes next? 5, 10, 15, 20, __",
        question: "Complete the number sequence: 5, 10, 15, 20, __",
        answer: "25",
        acceptedAnswers: ["25", "twenty five", "twenty-five"],
        hint: "Count forward by fives: add 5 to 20."
      },
      {
        id: "c5-s3-l1-q2",
        prompt: "What comes next? 10, 20, 30, 40, __",
        question: "Complete the number sequence: 10, 20, 30, 40, __",
        answer: "50",
        acceptedAnswers: ["50", "fifty"],
        hint: "Count forward by tens: add 10 to 40."
      },
      {
        id: "c5-s3-l1-q3",
        prompt: "Complete: RESPONSIBILIT_",
        question: "Fill in the missing letter: RESPONSIBILIT_",
        answer: "Y",
        acceptedAnswers: ["y", "responsibility"],
        hint: "The state or fact of having a duty to deal with something (ends with -ty)."
      },
      {
        id: "c5-s3-l1-q4",
        prompt: "Complete: COMMUNICATI_ N",
        question: "Fill in the missing letter: COMMUNICATI_ N",
        answer: "O",
        acceptedAnswers: ["o", "communication"],
        hint: "Exchanging information, news, or ideas through speech or writing (-tion)."
      },
      {
        id: "c5-s3-l1-q5",
        prompt: "Complete the exact spelling: ENVIRONMENT",
        question: "Type the exact spelling for our natural surroundings: ENVIRONMENT",
        answer: "ENVIRONMENT",
        acceptedAnswers: ["environment"],
        hint: "Remember the silent 'n' in the middle: en-vi-ron-ment."
      },
      {
        id: "c5-s3-l1-q6",
        prompt: "Complete: ACHIEVEMEN_",
        question: "Fill in the missing letter: ACHIEVEMEN_",
        answer: "T",
        acceptedAnswers: ["t", "achievement"],
        hint: "A thing done successfully typically by effort, courage, or skill (-ment)."
      },
      {
        id: "c5-s3-l1-q7",
        prompt: "Complete: CONCENTRATI_ N",
        question: "Fill in the missing letter: CONCENTRATI_ N",
        answer: "O",
        acceptedAnswers: ["o", "concentration"],
        hint: "The action or power of focusing all one's attention (-tion)."
      },
      {
        id: "c5-s3-l1-q8",
        prompt: "Complete: OBSERVATI_ N",
        question: "Fill in the missing letter: OBSERVATI_ N",
        answer: "O",
        acceptedAnswers: ["o", "observation"],
        hint: "The action or process of watching something carefully to gain information (-tion)."
      },
      {
        id: "c5-s3-l1-q9",
        prompt: "Complete: UNDERSTANDIN_",
        question: "Fill in the missing letter: UNDERSTANDIN_",
        answer: "G",
        acceptedAnswers: ["g", "understanding"],
        hint: "The ability to comprehend or grasp the meaning of something (-ing)."
      }
    ]
  },
  {
...
export const getModule3LevelsForClass = (classNumber = 1) => {
  const cls = Number(classNumber) || 1;
  if (cls >= 5) return CLASS5_STAGE3_BANK;
  if (cls === 4) return CLASS4_STAGE3_BANK;
  if (cls === 3) return CLASS3_STAGE3_BANK;
  if (cls === 2) return CLASS2_STAGE3_BANK;
  return CLASS1_STAGE3_BANK;
};
